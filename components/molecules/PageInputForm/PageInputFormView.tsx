...
const PageInputFormView = ({ storeName, name, price, addItem, handleName, handlePrice }: ItemInputFormProps & PageInputFormViewProps & ItemInputFormActionHandlersResult) => {
  const uiConfig = {
    FormBox: {
      sx: {
        paddingBottom: '1rem',
